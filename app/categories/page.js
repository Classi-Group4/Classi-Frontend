  ...
  return (
    ...
    <div className="mt-6 flex flex-wrap	grid grid-cols-3 gap-4">
      ...
      <div class="flex flex-col justify-center items-center max-w-sm mx-auto my-8">
        <div class="bg-gray-300 h-64 w-full rounded-lg shadow-md bg-cover bg-center w-96">
          <img
        ...
        <div class="w-56 md:w-64 bg-white -mt-10 shadow-lg rounded-lg overflow-hidden">
          ...
          <div class="flex items-center justify-center py-2 px-3 bg-gray-400">
            <button class=" bg-gray-800 text-xs text-white px-2 py-2 font-semibold rounded uppercase hover:bg-gray-700">
              See Classes
            </button>
          </div>
        </div>
      ...
      <div class="flex flex-col justify-center items-center max-w-sm mx-auto my-8">
        <div class="bg-gray-300 h-64 w-full rounded-lg shadow-md bg-cover bg-center">
          <img
            class="bg-gray-300 h-64 w-full rounded-lg shadow-md bg-cover bg-center w-96"
      ...
      </div><div class="flex flex-col justify-center items-center max-w-sm mx-auto my-8">
        <div class="bg-gray-300 h-64 w-full rounded-lg shadow-md bg-cover bg-center">
          <img
            class="bg-gray-300 h-64 w-full rounded-lg shadow-md bg-cover bg-center w-96"
