                ...
                <div class="relative block md:flex items-center">
                        ...
                        <div class="block sm:flex md:block lg:flex items-center justify-center">
                            <div class="mt-8 sm:m-8 md:m-0 md:mt-8 lg:m-8 text-center">
                                <div class="inline-flex items-center">
                                    <span class="text-3xl font-medium">Description</span>
                                    
                                </div>
                                <span class="block text-sm text-gray-600 mt-2">This class is a class that classes, the class teaches class stuff and class things</span>
                            </div>
                    ...
                    <div class="w-full md:w-1/2 relative z-0 px-8 md:px-0 md:py-16">
                        <div class="bg-[#576F72] text-white rounded-b md:rounded-b-none md:rounded-r shadow-lg overflow-hidden">
                            <div class="text-lg font-medium uppercase p-8 text-center border-b border-[#7D9D9C] tracking-wide">Teacher name</div>
                            ...
                            <div class="mt-8 border border-[#7D9D9C] mx-8 lg:mx-16 flex flex-wrap">
                                ...
                                <div class="flex items-center justify-center w-1/2 text-center p-4 border-b border-[#7D9D9C]">Teacher@teach.com</div>
