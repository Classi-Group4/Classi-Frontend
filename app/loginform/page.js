            ...
            <div className="flex flex-col w-full md:w-1/2 p-4 ">
                <div className="flex flex-col flex-1 justify-center mb-8">
                    ...
                    <div className="w-full mt-4">
                        <form className="form-horizontal w-3/4 mx-auto bg-opacity-70  drop-shadow-lg  rounded-md shadow-md" method="POST" action="#">
                            <div className="flex flex-col mt-4">
							<input id="username" 
							type="text" className="flex-grow h-8 px-2 rounded border border-grey-400" name="name" required placeholder="Username"/>
