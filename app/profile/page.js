  ...
  const handleClick = (e) => {
    ...
    axios.get(`http://localhost:8000/api/class/`)
        .then(res => {
            ...
            const filteredClasses = res.data.filter(item => item.teacher_email == email);
  ...
  return (
    <div>
      <div className="grid place-items-center  flex space-x-2 w-full bg-white shadow-md rounded-lg overflow-hidden mx-auto">
        <div className=" mt-4 card  min-w-sm border border-gray-700 bg-gray-700 text-gray-50   transition-shadow shadow-xl hover:shadow-xl min-w-max">
        ...
        <div className="flex items-center justify-center">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
            <div className="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
              ...
              <div className="mt-8">
                <p className="text-xl font-semibold my-2" href="/class">
                  Course Name
                </p>
