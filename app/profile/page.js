                    ...
                    <div className="w-full card__media"><img src="https://image.freepik.com/free-vector/abstract-binary-code-techno-background_1048-12836.jpg" className="h-48 w-96"/></div>
                        ...
                        <div className="flex items-center p-4">
                            <div className="relative flex flex-col items-center w-full">
                                ...
                                {userData ? (<div className="flex flex-col space-y-1 justify-center items-center -mt-12 w-full">
                                    <span className="text-md whitespace-nowrap text-gray-50 font-semibold">{userData.name}</span><span className="text-md whitespace-nowrap text-gray-100">{userData.user_type}</span>
                                    <p className="text-sm text-gray-200">
                                        {userData.email}
                                    </p>
                                    {userData.is_teacher ? (<div>Teacher</div>) : <div>Student</div>}
