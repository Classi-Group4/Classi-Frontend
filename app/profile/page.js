...
export default function Profile (){
    return (
        ...
        <div >
            <div class='grid place-items-center  flex space-x-2 w-full bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
             
             <div
                    class=" mt-4 card  min-w-sm border border-gray-700 bg-gray-700 text-gray-50   transition-shadow shadow-xl hover:shadow-xl min-w-max">
                        ...
                        <div class="flex items-center p-4">
                            <div class="relative flex flex-col items-center w-full">
                                ...
                                <div class="flex flex-col space-y-1 justify-center items-center -mt-12 w-full">
                                    <span class="text-md whitespace-nowrap text-gray-50 font-semibold">Name</span><span class="text-md whitespace-nowrap text-gray-100">user type</span>
        ...
        <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            ...
            <div class="mt-8">
                ...
                <div class="flex justify-between">
                    <div class="my-2">
                        <p class="font-semibold text-base mb-2">Teacher Name</p>
                     ...
                     <div class="my-2">
                        <p class="font-semibold text-base mb-2">Class Time </p>
